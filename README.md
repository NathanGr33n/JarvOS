...
This project is currently in **research and design phase**. Active documents and specifications are maintained in the [`ResearchDesign/`](ResearchDesign/) directory:
...
| Phase | Goal | Status |
|-------|------|--------|
| **Phase 1: Voice Shell** | Python PoC on a standard Linux desktop. Wake word → STT → LLM → TTS → action execution. | **Design Complete** |
| **Phase 2: Action Core** | Structured function-calling with JSON tool schemas, persistent memory, and a text-based HUD. | **Planned** |
